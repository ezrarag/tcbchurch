...
import { BookOpen, HeartHandshake, Users, ArrowRight, ShieldCheck } from "lucide-react";
...
export function MinistriesGrid({ ministries }: MinistriesGridProps) {
  const icons = [BookOpen, HeartHandshake, Users, ShieldCheck];
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="text-center space-y-2 max-w-2xl mx-auto">
          ...
          <p className="text-base text-slate-600">
            Empowering every generation through Christian education, childcare, biblical counseling, and community fellowship.
          </p>
        </div>
            ...
            return (
              <div key={ministry.id} className="bg-church-cream rounded-xl p-6 border border-slate-200 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between">
                <div className="space-y-3">
                  <div className="w-12 h-12 rounded-xl bg-church-navy text-church-gold flex items-center justify-center font-bold shadow-sm">
                ...
                <div className="pt-4 mt-4 border-t border-slate-200/80">
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 text-sm font-bold text-church-navy hover:text-church-gold transition-colors"
                  >
        ...
        <div className="text-center pt-2">
          <Link
            href="/ministries"
            className="inline-flex items-center gap-2 px-6 py-3 bg-church-navy hover:bg-slate-800 text-white font-bold rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-church-gold min-h-[44px]"
          >
            <span>Explore All Ministries & Programs</span>
