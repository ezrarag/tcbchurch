...
export function Footer() {
  return (
    <footer className="bg-[#120e0d] text-stone-300 pt-16 pb-10 border-t border-stone-800 text-left">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
